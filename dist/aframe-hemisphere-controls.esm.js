...
function KeyEventListener(Event) {
    ...
    switch (Event.key) {
        case 'Home':
            ...
            break;
        case 'ArrowLeft':
            rotateBy((Event.shiftKey ? 10 : 1) * Delta, 0);
            break;
        case 'ArrowRight':
            rotateBy(-(Event.shiftKey ? 10 : 1) * Delta, 0);
            break;
        case 'ArrowUp':
            rotateBy(0, (Event.shiftKey ? 10 : 1) * Delta);
            break;
        case 'ArrowDown':
            rotateBy(0, -(Event.shiftKey ? 10 : 1) * Delta);
            break;
    ...
    function rotateBy(horizontalAngle, verticalAngle) {
        var minAzimuthAngle = Orbiter.minAzimuthAngle, maxAzimuthAngle = Orbiter.maxAzimuthAngle, minPolarAngle = Orbiter.minPolarAngle, maxPolarAngle = Orbiter.maxPolarAngle;
        ...
        Orbiter.update();
        Object.assign(Orbiter, { minAzimuthAngle: minAzimuthAngle, maxAzimuthAngle: maxAzimuthAngle, minPolarAngle: minPolarAngle, maxPolarAngle: maxPolarAngle });
        Orbiter.update();
    }
}
//# sourceMappingURL=aframe-hemisphere-controls.esm.js.map
